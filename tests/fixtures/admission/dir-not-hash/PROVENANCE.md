# Provenance: `dir-not-hash` (admission case, A §8.3 (1) step 2)
...
the set directory renamed to `Dockerfile/ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff` and the pointer repointed to it (half-replaced).
...
- `tree/.deployer/authoring/Dockerfile/ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff/record.json`: added
- `tree/.deployer/authoring/Dockerfile/ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff/record.json.sig`: added
- `tree/.deployer/authoring/Dockerfile/ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff/snapshot.json`: added
