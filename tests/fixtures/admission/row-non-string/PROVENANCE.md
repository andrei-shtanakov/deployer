# Provenance: `row-non-string` (admission case, A §8.3 (1) step 6, a non-string field)
...
the snapshot's first tree row gets `mode` `100644` as a number, re-signed (new set directory).
...
- `tree/.deployer/authoring/Dockerfile/97c2280c148ad16d741be6d1b7e456c8e0ec8b9216eff8e9889369f8ed4d4f72/record.json`: added
- `tree/.deployer/authoring/Dockerfile/97c2280c148ad16d741be6d1b7e456c8e0ec8b9216eff8e9889369f8ed4d4f72/record.json.sig`: added
- `tree/.deployer/authoring/Dockerfile/97c2280c148ad16d741be6d1b7e456c8e0ec8b9216eff8e9889369f8ed4d4f72/snapshot.json`: added
