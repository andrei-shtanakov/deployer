# Provenance: `syntax-directive` (admission case, A §8.3 (3) differences, `# syntax=` on the `run-1` COPY case)
...
`tree/Dockerfile` starts with `# syntax=docker/dockerfile:1` in place of the blank line after `FROM` (lines 3 on keep their numbers), made *before* the set was issued. The recorded logs are the base's: no build with the directive was run; the refusal is the directive itself (A §4.3).
...
- `tree/.deployer/authoring/Dockerfile/24019690add0379f4d472d73bf78f70a60bc0cdfbfa91b4d43f1364af4865c2c/record.json`: added
- `tree/.deployer/authoring/Dockerfile/24019690add0379f4d472d73bf78f70a60bc0cdfbfa91b4d43f1364af4865c2c/record.json.sig`: added
- `tree/.deployer/authoring/Dockerfile/24019690add0379f4d472d73bf78f70a60bc0cdfbfa91b4d43f1364af4865c2c/snapshot.json`: added
