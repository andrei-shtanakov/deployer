# Provenance: `snapshot-edited` (admission case, A §8.3 (1) step 5)
...
`snapshot.json` re-serialised with two-space indentation, still parseable; record and signature unchanged.
