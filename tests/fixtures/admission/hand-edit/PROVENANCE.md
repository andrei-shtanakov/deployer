# Provenance: `hand-edit` (admission case, A §8.3 (1) step 4, Dockerfile hand-edited after authoring)
...
`tree/Dockerfile` gains a last line `# edited by hand after authoring` after the set was issued (set unchanged).
