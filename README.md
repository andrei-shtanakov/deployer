...
`#k CACHED` never confirms; if the build failed, the failure must be provably at a
later step of the COPY's stage. FROM is file-wide: a named build-stage header and no
